Translation = {
    ...
    Arabic = {
    Notify = {
        testText = "هذا إشعار تجريبي",
        userNonExistent = "المعرف غير صحيح أو اللاعب غير موجود.",
        ReadSuggestion = "الرجاء قراءة تعليمات الشات لمعرفة طريقة استخدام الأمر.",
        SetGroup = "أعطيت اللاعب مجموعة (ID: %d)",
        SetGroup1 = "الإدارة أعطتك مجموعة: %s",
        AddJob = "أعطيت اللاعب (ID: %d) وظيفة %s برتبة %d",
        AddJob1 = "الإدارة أعطتك وظيفة %s برتبة %d",
        error = "اكتب 0 للنقود و 1 للذهب",
        AddMoney = "أعطيت اللاعب (ID %d) مبلغ %d",
        AddMoney1 = "استلمت من الإدارة مبلغ %d",
        invfull = "مخزونك ممتلئ",
        cantcarry = "لا يمكنك حمل المزيد من هذا العنصر",
        removedcurrency = "أزلت %d$ من اللاعب (ID: %d)",
        revived = "تم إنعاش اللاعب (ID: %d)",
        radius = "النطاق يجب أن يكون أكبر من 1",
        namechange = "تم تغيير اسمك إلى: %s %s بواسطة الإدارة",
        banned = "تم حظر اللاعب نهائيًا",
        banned2 = "تم حظر اللاعب حتى ",
        banned3 = "لقد تم حظرك نهائيًا!",
        healself = "لقد عالجت نفسك.",
        healall = "تم علاج جميع اللاعبين.",
        healedPlayer = "تم علاج اللاعب (ID: %d)",
        AddItems = "تمت إضافة العنصر %s × %d إلى مخزونك",
        AddWeapons = "تمت إضافة سلاح إلى مخزونك",
        Exp = "تم إعطاء خبرة للاعب",
        GivenExp = "لقد استلمت %s خبرة في %s",
        NotFound = "المهارة غير موجودة",
        Level = "أنت %s بالمستوى %s ولديك %s خبرة في %s",
        left = {
            title = "~e~مهم!",
            subtitle = "يجب أن تضبط طول شخصيتك إلى 1.0، قد تظهر أخطاء إذا لم تفعل.",
            dict = "minigames_hud",
            icon = "five_finger_burnout",
            color = "COLOR_RED",
        },
        left1 = {
            title = "~e~مهم!",
            subtitle = "بمجرد ~e~حذف ~q~شخصية لن يمكنك استرجاعها!",
            dict = "minigames_hud",
            icon = "five_finger_burnout",
            color = "COLOR_RED",
        },
    ...
    Commands = {
        webHookMessage = "**اسم ستيم: **`%s`\n**المعرف:** `%s`\n**ديسكورد:** <@%s>\n**IP:** `%s`",

        addGroup = {
            custom = "\n**معرف اللاعب:** `%d`\n**المجموعة المعطاة:** `%s`",
            tittle = "📋 أمر `/addGroup`",
            label = "أمر لتعيين مجموعة للاعب",
            help = 'معرف اللاعب',
            help1 = 'اسم المجموعة',
            name = "المعرف",
            name1 = "المجموعة"
        ...
        addJob = {
            custom = "\n**معرف اللاعب:** `%d`\n**الوظيفة المعطاة:** `%s`\n**الرتبة:** `%d`",
            tittle = "📋 أمر `/job`",
            label = "أمر لتعيين وظيفة ورُتبة للاعب",
            help = 'معرف اللاعب',
            help1 = 'اسم الوظيفة',
            help2 = 'الرتبة',
            help3 = 'اسم العرض',
        ...
        addWeapon = {
            custom = "\n**معرف اللاعب:** `%d`\n**السلاح المعطى:** `%s`",
            title = "📋 أمر `/addweapon`",
            label = "أمر لإعطاء أسلحة",
            help = 'معرف اللاعب',
            help1 = 'اسم السلاح (Hash)',
            name = "المعرف",
            name1 = "السلاح",
        },
        ...
        addMoney = {
            custom = "\n**معرف اللاعب:** `%d`\n**النوع:** `%d`\n**المبلغ:** `%d`",
            title = "📋 أمر `/addmoney`",
            label = "أمر لإعطاء نقود",
            help = 'معرف اللاعب',
            help1 = '0 للنقود - 1 للذهب - 2 rol',
            help2 = 'الكمية',
            name = "المعرف",
            name1 = "النوع",
            name2 = "الكمية",
        ...
        delMoney = {
            custom = "\n**معرف اللاعب:** `%d`\n**النوع:** `%d`\n**المبلغ:** `%d`",
            title = "📋 أمر `/delmoney`",
            label = "أمر لحذف النقود",
            help = 'معرف اللاعب',
            help1 = '0 للنقود - 1 للذهب',
            help2 = 'الكمية',
            name = "المعرف",
            name1 = "النوع",
            name2 = "الكمية",
        ...
        ban = {
            ...
            name1 = "المدة",
            help = "أدخل Steam ID",
            help1 = "مدة الحظر: d يوم - w أسبوع - m شهر - y سنة. مثال: /ban steamid d2 = يومين",
        },

        unBan = {
            custom = "\n**معرف اللاعب:** `%d`\n**الإجراء:** `%s`",
            title = "📋 أمر `/unban`",
            label = "أمر لفك الحظر عن لاعب",
            name = "ستيمID",
            help = "أدخل Steam ID",
        },
        ...
        warn = {
            custom = "\n**معرف اللاعب:** `%d`\n**الإجراء:** `تم تحذيره`",
            title = "📋 أمر `/warn`",
            label = "أمر لتحذير لاعب",
            name = "ستيمID",
            help = "أدخل Steam ID",
        },

        unWarn = {
            custom = "\n**معرف اللاعب:** `%d`\n**الإجراء:** `تم إزالة التحذير`",
            title = "📋 أمر `/unwarn`",
            label = "أمر لإلغاء تحذير لاعب",
            name = "ستيمID",
            help = "أدخل Steam ID",
        },
    },
    ...
    MessageOfSystem = {
        IsConnected = "❌ تم الرفض: تم اكتشاف دخول بحساب مكرر (Steam | Rockstar)",
        TwoAccounts = "❌ تم الرفض: محاولة دخول من حساب آخر.",
        TwoAccounts2 = "❌ تم الرفض: Steam ID مسجل بالفعل في السيرفر.",
        NoSteam = "❌ مطلوب Steam: افتح Steam ثم أعد تشغيل RedM.",
        NoDiscord = "❌ مطلوب Discord: افتح Discord ثم أعد تشغيل RedM.",
        NoInWhitelist = "❌ تم الرفض: لست في القائمة البيضاء. أرسل Steam ID في ديسكورد:",
        NoPermissions = "ليس لديك صلاحيات كافية",
        BannedUser = "لقد تم حظرك حتى ",
        permanentlyBan = "لقد تم حظرك نهائيًا!",
        Warned = "لقد تم تحذيرك",
        Unwarned = "تمت إزالة التحذير عنك",
        TitleOnDead = "اكتب /calldoctor في الشات لطلب مساعدة الطبيب",
        SubTitleOnDead = "يمكنك الإنعاش خلال %s ثانية",
        YouAreCarried = "أنت محمول من لاعب آخر",
        RespawnIn = "يمكنك الإنعاش بعد ",
        message6 = "تم الإنعاش!!!",
