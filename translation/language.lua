Translation = {
    ...
    Espanol      = {
        Notify          = {
            userNonExistent = "El ID es incorrecto o el usuario no existe.",
            ReadSuggestion = "Por favor, lee las sugerencias en el chat sobre cómo usar el comando.",
            SetGroup = "Has asignado el grupo al ID: %d",
            SetGroup1 = "El administrador te asignó el grupo %s",
            AddJob = "Has asignado el trabajo %s al ID %d con rango %d",
            AddJob1 = "El personal te asignó el trabajo %s con rango %d",
            error = "escribe 0 para dinero y 1 para oro",
            AddMoney = "Has asignado la moneda %d al ID %d",
            AddMoney1 = "Recibido del administrador una cantidad de %d",
            invfull = "el inventario está lleno",
            cantcarry = "no puedes llevar más de este objeto",
            removedcurrency = "Has eliminado %d $ del ID: %d",
            revived = "el jugador con ID de servidor %d ha sido revivido",
            radius = "el radio debe ser mayor que 1",
            namechange = "Tu nombre ha sido cambiado a: %s %s por un administrador",
            banned = "fue baneado permanentemente",
            banned2 = "baneó a alguien hasta",
            banned3 = "¡Has sido baneado permanentemente!",
            healself = "Te has revivido a ti mismo.",
            healall = "Has sido curado.",
            left = {
                title = "~e~¡IMPORTANTE!",
                subtitle = "debes ajustar la altura de tu personaje a 1.0, habrá errores si no lo haces.",
                dict = "minigames_hud",
                icon = "five_finger_burnout",
                color = "COLOR_RED",
            },
            left1 = {
                title = "~e~¡IMPORTANTE!",
                subtitle = "¡Una vez que ~e~borres ~q~un personaje, no hay vuelta atrás!",
                dict = "minigames_hud",
                icon = "five_finger_burnout",
                color = "COLOR_RED",
            },
        ...
        Commands        = {
            webHookMessage = "**Nombre de Steam: **`%s`**\nIdentificador:**`%s` \n**Discord:** <@%s>**\nIP: **`%s`",
            addGroup = {
                custom = "\n**ID de jugador** `%d`\n**Grupo asignado** `%s`",
                tittle = "📋 `/comando Grupo`",
                label = "Comando VORPcore para asignar grupo a jugador",
                help = 'ID de jugador',
            ...
            addJob = {
                custom = "\n**ID de jugador:** `%d` \n**Trabajo asignado** `%s`\n**Grado:** `%d`",
                tittle = "📋 `/comando Trabajo`",
                label = "Comando VORPcore para asignar trabajo y grado a jugador",
                help = 'ID de jugador',
                help1 = 'Nombre del trabajo',
                help2 = 'Grado del trabajo',
                name = "Id",
                name1 = "NombreTrabajo",
                name2 = "GradoTrabajo",
            },
            addItem = {
                custom = "\n**ID de jugador:** `%d` \n**Objeto asignado** `%s`\n**Cantidad:** `%d`",
                title = "📋` /comando agregarObjeto` ",
                label = "Comando VORPcore para dar objetos",
                help = 'ID de jugador',
                help1 = 'Nombre del objeto',
                help2 = 'Cantidad',
                name = "Id",
                name1 = "NombreObjeto",
                name2 = "Cantidad",
            ...
            delMoney = {
                custom = "\n**ID de jugador** `%d` \n**Tipo** `%d`\n**Cantidad** `%d`",
                title = "📋` /comando eliminarDinero` ",
                label = "Comando VORPcore para eliminar dinero",
                help = 'ID de jugador',
                help1 = 'Tipo 0 para dinero y 1 para oro',
                help2 = 'Cantidad',
                name = "Id",
                name1 = "tipo",
                name2 = "Cantidad",
            ...
            addMoney = {
                custom = "\n**ID de jugador** `%d` \n**Tipo** `%d`\n**Cantidad** `%d`",
                title = "📋` /comando agregarDinero` ",
                label = "Comando VORPcore para dar dinero",
                help = 'ID de jugador',
                help1 = 'Tipo 0 para dinero y 1 para oro',
                help2 = 'Cantidad',
                name = "Id",
            ...
            delWagons = {
                custom = "`\n**ID de jugador:** `%d`\n **Acción:** `Usó delwagons` \n **Radio:** `%d`",
                title = "📋`Comando /delwagons`",
                label = "Comando VORPcore para eliminar vagones dentro de un radio",
                help = 'añade un número del 1 en adelante',
                name = "radio",
            },
            revive = {
                custom = "`\n**ID de jugador:** `%d`\n **Acción:** `Fue revivido`",
                title = "📋`Comando /revive`",
                label = "Comando VORPcore para revivir a un jugador",
                help = 'ID del jugador',
                name = "Id",
            },
            teleport = {
                custom = "`\n**ID de jugador:** `%d`\n **Acción:** `Fue teleportado`",
                title = "📋`Comando /teleport`",
                label = "Comando VORPcore para teleportar",
                help = 'ID del jugador',
                name = "Id",
            ...
            delHorse = {
                custom = "`\n**ID de jugador:** `%d `\n **Acción:** `Usó Delhorse`",
                title = "📋`Comando /delhorse`",
                label = "Comando VORPcore para eliminar caballos",
            },
            heal = {
                custom = "`\n**ID de jugador:** `%d `\n **Acción:** `Usó Heal`",
                title = "📋`Comando /heal`",
                label = "Comando VORPcore para curar a un jugador",
                name = "Id",
                help = 'ID del jugador',
            },
            addWhitelist = {
                custom = "`\n**ID de jugador:** `%d `\n **Acción:** `Usó Whitelist`",
                title = "📋`Comando /whitelist`",
                label = "Comando VORPcore para añadir a un jugador en la lista blanca",
                name = "Steamid",
                help = "ID de Steam, ejemplo: 11000010c8aa16e",
            },
            unWhitelist = {
                custom = "`\n**ID de jugador:** `%d `\n **Acción:** `Usó Unwhitelist`",
                title = "📋`Comando /unwhitelist`",
                label = "Comando VORPcore para eliminar a un jugador de la lista blanca",
                name = "Steamid",
                help = "ID de Steam, ejemplo: 11000010c8aa16e",
            },
            ban = {
