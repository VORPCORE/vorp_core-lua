...
AddEventHandler("vorpbans:addtodb", function(status, id, datetime)
    ...
    exports.ghmattimysql:execute("UPDATE users SET banned = @banned, banneduntil=@time WHERE identifier = @identifier",
...
AddEventHandler("vorpwarns:addtodb", function(status, id)
    ...
    exports.ghmattimysql:execute("UPDATE users SET warnings = @warnings WHERE identifier = @identifier",
